...
def get_config():
    ...
    pretrained.model = "/workspace/ddpo-pytorch/models/models--runwayml--stable-diffusion-v1-5/snapshots/451f4fe16113bff5a5d2269ed5ad43b0592e9a14"
    # revision of the model to load.
    pretrained.revision = "main"

    ###### Input Image ######
    config.input_image = input_image = ml_collections.ConfigDict()
    # path to the input image directory
    input_image.image_dir = "/workspace/SSL-Backdoor/data/ImageNet-100/train"
    # size of input images (will be resized if not this size)
    input_image.size = 512
    # strength parameter for img2img (0-1), higher means more modification
    input_image.strength = 1
    # whether to use class-balanced sampling (useful for ImageNet-style directories)
    input_image.class_balanced_sampling = True
    # supported image extensions (will also try uppercase versions)
    input_image.extensions = ['.jpg', '.jpeg', '.png', '.JPEG']
    ...
    config.prompt_fn = "single_sentence"
