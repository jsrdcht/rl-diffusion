...
def get_config():
    ...
    config.run_name = "imagenet-all_feature_similarity_reward_ddpo"
    ...
    config.prompt_fn = "imagenet_all"
    # kwargs to pass to the prompt function.
    config.prompt_fn_kwargs = {}

    ###### Reward Function ######
    # reward function to use. see `rewards.py` for available reward functions.
    config.reward_fn = "feature_similarity_reward"
    ...
    ###### per optimization reward normalization ######
    config.per_optimization_reward_normalization = False
